                    ...
                    <div className="max-w-4xl">
                        <Reveal delay={0}>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-[10px] font-bold tracking-[0.3em] text-avanti-gold uppercase">{t('resources.badge')}</span>
                            </div>
                        </Reveal>
                        <h1 className="text-4xl md:text-7xl font-serif font-medium text-white mb-6 leading-tight tracking-tight">
